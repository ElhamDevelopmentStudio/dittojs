    ...
    <main className="landing-page" id="builder">
      <section className="hero-panel">
        <div className="hero-layout">
          ...
          <figure className="hero-inspiration" aria-labelledby="hero-inspiration-title">
            <img src={dittoInspirationUrl} alt="Grayscale Ben 10 Ditto character asset" />
            <figcaption>
              <span>Origin note</span>
              <strong id="hero-inspiration-title">Name inspired by Ben 10's Ditto.</strong>
            </figcaption>
          </figure>
        </div>
      </section>
